...
import { API_URL, setAuthCookie } from '@/lib/auth';
      ...
      <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col justify-center px-6 py-10 lg:flex-row lg:items-center lg:gap-10">
        ...
        <section className="relative z-10 flex-1 py-10">
          ...
          <p className="mt-6 max-w-2xl text-lg text-black/65">
            On first signup we collect the basics: your pet&apos;s name, gender, supported
            species, and the sprite that feels closest. After that, the dashboard uses those
            exact GIFs for the live pet display.
          </p>
